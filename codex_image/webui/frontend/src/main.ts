...
import { initCompactWorkspace } from "./compact-workspace";
import { initMobileShell } from "./mobile-shell";
import { initMobileWorkspace } from "./mobile-workspace";
import { initComposerDraft } from "./composer-draft";
...
import { initUserConfigBackupFeature } from "./user-config-backup";
...
import { initEditRequestPreflightFeature } from "./edit-request-preflight";
import { initTaskListControlsFeature } from "./task-list-controls";
import { initTaskCardSwipeFeature } from "./task-card-swipe";

...
export const EN_DICTIONARY: TranslationDictionary = {
    ...
    "mobile.gestureHint": "Pinch to zoom · Swipe to switch images",
    ...
    "batch.cancelDetail": "Running {running} · waiting {waiting}",
    ...
    "history.clear": "Clear",
    "history.activeFilterCount": "Filtered · {count}",
    ...
    "history.exportSummary": "{taskCount} tasks · {imageCount} images",
    ...
    "historyBackup.scopeLocked": "Scope locked: {scope} · {eligible} tasks will be backed up",
    "historyBackup.scopeLockedPending": "Scope locked: {scope} · counting eligible tasks",
    ...
    "historyBackup.stats": "Total {total} · eligible {eligible} · excluded {excluded} · {bytes}",
    ...
    "history.type.imageToImage": "Image to image",
    "history.month": "Month",
    "history.status": "Status",
    "history.promptMode": "Prompt handling",
    "history.size": "Size",
    ...
    "history.promptMode.strict": "Faithful",
    "history.promptMode.original": "Original",
    "history.promptMode.off": "Automatic",
    ...
    "imageInput.uploadAria": "Click, drop, or paste images and files",
    "imageInput.uploadFull": "Click, drop, or paste images and files",
    "imageInput.uploadCompact": "Add input",
    "imageInput.uploadSubtitle": "Supports images and Responses reference files",
...
"output.lock.search": "Search",
    ...
    "output.modeCreative": "Automatic",
    "output.promptHelp": "Explain prompt handling",
    "output.promptHelpTitle": "Prompt handling",
    "output.promptHelp.responsesChannel": "Responses · main model involved",
    "output.promptHelp.imagesChannel": "Images · direct generation",
    ...
    "userConfigBackup.previewCounts": "{count} in archive · {duplicate} duplicates · {conflict} conflicts",
    "userConfigBackup.previewSectionCounts": "Backup {archive} · current {current}",
    ...
    "userConfigBackup.archiveMeta": "{count} sections · format v{version}",
    ...
    "userConfigBackup.resultCounts": "{section}: {added} added · {replaced} replaced · {skipped} skipped · {copies} recovery copies",
    ...
    "apiSettings.searchProviders": "Search provider names",
    "apiSettings.noProviderSearchResults": "No matching providers",
    ...
    "apiSettings.providerIconPlaceholder": "Optional, e.g. 🪄",
    ...
    "referenceFiles.familyPdf": "Pages + text",
    "referenceFiles.familySpreadsheet": "Spreadsheet",
    "referenceFiles.familyDocument": "Document",
    "referenceFiles.familyText": "Text",
    "referenceFiles.visualLimit": "Embedded images and charts are not preserved in non-PDF files. Convert to PDF when layout matters.",
    "referenceFiles.remove": "Remove {filename}",
    ...
    "referenceFiles.providerMissing": "The original Responses provider is unavailable. Choose one in API settings.",
    "referenceFiles.missing": "File missing",
    "referenceFiles.loadFailed": "Failed to load reference files",
    "referenceFiles.errorEmpty": "The reference file is empty",
    "referenceFiles.errorUnsupported": "This reference file type is unsupported",
    "referenceFiles.errorMismatch": "The file type does not match its extension",
    "referenceFiles.errorInvalid": "The reference file is invalid",
    "referenceFiles.errorTooLarge": "Each reference file must be smaller than 50 MB",
    "referenceFiles.errorTotalTooLarge": "Reference files may total at most 50 MB",
    "referenceFiles.errorMissing": "A selected reference file is missing",
    "referenceFiles.errorProviderUnsupported": "This provider does not support reference files in Responses",
    "referenceFiles.responsesEnabled": "Responses enabled",
    ...
    "imageEditor.guidance": "Editing Guidance", "imageEditor.instructionMarksGuidance": "Instruction Marks", "imageEditor.editRegionGuidance": "Mask", "imageEditor.maskTools": "Mask Tools", "imageEditor.maskPaint": "Paint", "imageEditor.maskErase": "Erase Brush", "imageEditor.maskRectangle": "Rectangle", "imageEditor.maskEllipse": "Circle", "imageEditor.maskRestore": "Restore Mask", "imageEditor.maskClear": "Reset Mask", "imageEditor.maskHelp": "Blue masked areas are preserved. Transparent areas erased with the brush, rectangle, or circle will be edited.", "imageEditor.emptyEditRegion": "Erase a transparent area from the mask before saving.", "imageInput.instructionMarksApplied": "Instruction Marks applied", "imageInput.editRegionApplied": "Edit Region applied",
    ...
    "editPreflight.responsesResize": "Responses will temporarily resize request copies of the image and mask from {width}×{height} to {targetWidth}×{targetHeight}; the original files remain unchanged",

...
class WebUIStaticLayoutTests(WebUIStaticTestCase):
    ...
    def test_api_source_switcher_and_system_settings_modal_exist(self) -> None:
        ...
        self.assertIn('id="saveCodexSettingsButton"', html)
        ...
        self.assertLess(html.index('id="apiSettingsActions"'), html.index('id="saveApiSettingsButton"'))
        self.assertLess(html.index('id="apiSettingsStatus"'), html.index('id="saveApiSettingsButton"'))
        self.assertLess(html.index('id="codexSettingsStatus"'), html.index('id="saveCodexSettingsButton"'))
        ...
        self.assertIn("saveCodexSettingsButton: document.querySelector", script)
        self.assertIn('saveCodexSettingsButton?.addEventListener("click", () => call(methods, "saveApiSettings"))', script)
        ...
        self.assertIn("readApiSettingsForm({ applyProviderDraft: true })", script)
        ...
        self.assertIn('return mode === "responses" ? "Responses" : "Image"', script)
        ...
        self.assertIn('default: translate("codexSettings.save")', script)
        self.assertIn('default: translate("apiSettings.saveSelection")', script)
        self.assertIn('default: translate("apiSettings.saveProvider")', script)
        self.assertRegex(script, r"saveApiSettingsButton\)[^\n]*saveApiSettingsButton\.textContent = apiText")
        self.assertRegex(script, r"saveApiProviderEditButton\)[^\n]*saveApiProviderEditButton\.textContent = providerText")
        self.assertRegex(script, r"saveCodexSettingsButton\)[^\n]*saveCodexSettingsButton\.textContent = codexText")
        ...
        self.assertIn('return [backend, provider].filter(Boolean).join(" · ")', script)

...
class PortablePackagingTests(unittest.TestCase):
    def test_all_packaged_webui_entrypoints_persist_network_egress_settings(self) -> None:
        ...
        expected = (
            'network_egress_settings_path=DATA_DIR '
            '/ "webui-network-egress-settings.json"'
        )

        for entrypoint in entrypoints:
            text = entrypoint.read_text(encoding="utf-8")
            self.assertIn(expected, text, str(entrypoint))
    ...
    def test_windows_portable_packaging_files_define_self_contained_bundle(self) -> None:
        ...
        self.assertIn("iLab CONJURE portable updater", updater_helper_text)
    ...
    def test_macos_portable_packaging_files_define_arch_specific_bundles(self) -> None:
        ...
        self.assertIn("<string>iLab CONJURE</string>", build_text)
        ...
        self.assertIn("iLab CONJURE portable updater", updater_text)
    ...
    def test_macos_standard_app_packaging_builds_unsigned_dmg(self) -> None:
        ...
        self.assertIn("<string>iLab CONJURE</string>", build_text)
        self.assertIn('hdiutil create -volname "iLab CONJURE"', build_text)
        ...
        self.assertIn("# iLab CONJURE macOS Standard App package", readme_text)
    ...
    def test_windows_standard_app_zip_packaging_is_not_an_installer(self) -> None:
        ...
        self.assertIn("# iLab CONJURE Windows Standard App ZIP", readme_text)
        self.assertIn("portable data", readme_text)
    ...
    def test_portable_release_workflow_runs_after_ci_success(self) -> None:
        ...
        self.assertIn("此版本包含 iLab CONJURE 对应 tag 的源码和免安装一键包。", text)
